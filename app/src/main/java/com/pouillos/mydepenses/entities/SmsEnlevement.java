...
public class SmsEnlevement {
    ...
    @Generated(hash = 720594257)
    private transient SmsEnlevementDao myDao;

    @Generated(hash = 54455073)
    public SmsEnlevement(Long id, long contactId, @NotNull String message) {
        this.id = id;
        this.contactId = contactId;
        this.message = message;
    }

    @Generated(hash = 1138337840)
    public SmsEnlevement() {
    }
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 1769657911)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getSmsEnlevementDao() : null;
    }
